    ...
    public class JournalVoucherController : Controller
    {
        ...
        public async Task<IActionResult> CreateLiquidation(JournalVoucherViewModel viewModel, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var generateJvNo = await _unitOfWork.FilprideJournalVoucher.GenerateCodeAsync(viewModel.Type, cancellationToken);
                ...
                FilprideAuditTrail auditTrailBook = new(model.CreatedBy, $"Created new journal voucher# {model.JournalVoucherHeaderNo}", "Journal Voucher");
        ...
        public async Task<IActionResult> Print(int? id, CancellationToken cancellationToken)
        {
            ...
            FilprideAuditTrail auditTrailBook = new(GetUserFullName(), $"Preview journal voucher# {header.JournalVoucherHeaderNo}", "Journal Voucher");
        ...
        public async Task<IActionResult> Post(int id, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                FilprideAuditTrail auditTrailBook = new(modelHeader.PostedBy!, $"Posted journal voucher# {modelHeader.JournalVoucherHeaderNo}", "Journal Voucher");
                await _dbContext.AddAsync(auditTrailBook, cancellationToken);
        ...
        public async Task<IActionResult> Void(int id, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                FilprideAuditTrail auditTrailBook = new(model.VoidedBy!, $"Voided journal voucher# {model.JournalVoucherHeaderNo}", "Journal Voucher");
                await _dbContext.AddAsync(auditTrailBook, cancellationToken);
        ...
        public async Task<IActionResult> Cancel(int id, string? cancellationRemarks, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                FilprideAuditTrail auditTrailBook = new(model.CanceledBy!, $"Canceled journal voucher# {model.JournalVoucherHeaderNo}", "Journal Voucher");
                await _dbContext.AddAsync(auditTrailBook, cancellationToken);
        ...
        public async Task<IActionResult> EditLiquidation(JournalVoucherViewModel viewModel, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                FilprideAuditTrail auditTrailBook = new(existingHeaderModel.EditedBy!, $"Edited journal voucher# {existingHeaderModel.JournalVoucherHeaderNo}", "Journal Voucher");
                await _dbContext.AddAsync(auditTrailBook, cancellationToken);
        ...
        public async Task<IActionResult> Printed(int id, CancellationToken cancellationToken)
        {
            ...
            if (cv.IsPrinted == false)
            {
                ...
                FilprideAuditTrail auditTrailBook = new(GetUserFullName(), $"Printed original copy of journal voucher# {cv.JournalVoucherHeaderNo}", "Journal Voucher");
                await _unitOfWork.FilprideAuditTrail.AddAsync(auditTrailBook, cancellationToken);
            ...
            else
            {
                ...
                FilprideAuditTrail auditTrailBook = new(GetUserFullName(), $"Printed re-printed copy of journal voucher# {cv.JournalVoucherHeaderNo}", "Journal Voucher");
                await _unitOfWork.FilprideAuditTrail.AddAsync(auditTrailBook, cancellationToken);
        ...
        public async Task<IActionResult> Export(string selectedRecord)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet5.Cells["AH1"].Value = "EditedBy";
                worksheet5.Cells["AI1"].Value = "EditedDate";
                worksheet5.Cells["AJ1"].Value = "CanceledBy";
                worksheet5.Cells["AK1"].Value = "CanceledDate";
                worksheet5.Cells["AL1"].Value = "VoidedBy";
                worksheet5.Cells["AM1"].Value = "VoidedDate";
                ...
                worksheet.Cells["P1"].Value = "CanceledBy";
                worksheet.Cells["Q1"].Value = "CanceledDate";
                worksheet.Cells["R1"].Value = "VoidedBy";
                worksheet.Cells["S1"].Value = "VoidedDate";
                ...
                foreach (var item in selectedList)
                {
                    ...
                    worksheet.Cells[row, 16].Value = item.CanceledBy;
                    worksheet.Cells[row, 17].Value = item.CanceledDate?.ToString("yyyy-MM-dd HH:mm:ss.ffffff") ?? null;
                    worksheet.Cells[row, 18].Value = item.VoidedBy;
                    worksheet.Cells[row, 19].Value = item.VoidedDate?.ToString("yyyy-MM-dd HH:mm:ss.ffffff") ?? null;
                ...
                foreach (var item in selectedList)
                {
                    ...
                    worksheet5.Cells[cvhRow, 34].Value = item.CheckVoucherHeader.EditedBy;
                    worksheet5.Cells[cvhRow, 35].Value = item.CheckVoucherHeader.EditedDate?.ToString("yyyy-MM-dd HH:mm:ss.ffffff") ?? null;
                    worksheet5.Cells[cvhRow, 36].Value = item.CheckVoucherHeader.CanceledBy;
                    worksheet5.Cells[cvhRow, 37].Value = item.CheckVoucherHeader.CanceledDate?.ToString("yyyy-MM-dd HH:mm:ss.ffffff") ?? null;
                    worksheet5.Cells[cvhRow, 38].Value = item.CheckVoucherHeader.VoidedBy;
                    worksheet5.Cells[cvhRow, 39].Value = item.CheckVoucherHeader.VoidedDate?.ToString("yyyy-MM-dd HH:mm:ss.ffffff") ?? null;
        ...
        public async Task<IActionResult> ReJournalJv(int? month, int? year, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var existingGlEntries = await _dbContext.FilprideGeneralLedgerBooks
                    .Where(x => jvReferences.Contains(x.Reference))
                    .ToListAsync(cancellationToken);
        ...
        public async Task<IActionResult> CreateAccrual(JvCreateAccrualViewModel viewModel, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var generateJvNo = await _unitOfWork.FilprideJournalVoucher.GenerateCodeAsync(cv.Type, cancellationToken);
        ...
        public async Task<IActionResult> Unpost(int id, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                FilprideAuditTrail auditTrailBook = new(GetUserFullName(), $"Unposted journal voucher# {jvHeader.JournalVoucherHeaderNo}", "Journal Voucher");
                await _unitOfWork.FilprideAuditTrail.AddAsync(auditTrailBook, cancellationToken);
        ...
        public async Task<IActionResult> Approve(int id, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                FilprideAuditTrail auditTrailBook = new(GetUserFullName(), $"Approved journal voucher# {model.JournalVoucherHeaderNo}", "Journal Voucher");
                await _unitOfWork.FilprideAuditTrail.AddAsync(auditTrailBook, cancellationToken);
